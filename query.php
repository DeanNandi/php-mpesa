...
$CheckoutRequestID = 'ws_CO_18122023213920126724820325';
...
if (isset($data_to->ResultCode)) {
  ...
  if ($ResultCode == '1037') {
    $massage = "Timeout error; the transaction was Incomplete";
  } elseif ($ResultCode == '1032') {
    $massage = "The Transaction was Cancelled by the User";
  } elseif ($ResultCode == '1') {
    $massage = "The balance was Insufficient to make the Transaction";
  } elseif ($ResultCode == '0') {
    $massage = "The Transaction was made Successfully";
  }
}
